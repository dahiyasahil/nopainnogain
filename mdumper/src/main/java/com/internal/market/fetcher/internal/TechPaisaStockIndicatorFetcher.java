...
public class TechPaisaStockIndicatorFetcher implements Fetcher {
	...
	/*
	 * http://techpaisa.com/api/stock-screener/?app_id=f17ff0dd&app_key=274ca69cc1c5fbf844d6fed929383fcc&ind=nifty&result=json&ts=on&foi=on
	 * (non-Javadoc)
	 * @see com.internal.market.fetcher.Fetcher#fetchMarketFeeds(java.lang.String, java.lang.String)
	 */
	...
	public float getAvgTechnicalStrengthOfStock(String stockMarketName, String company) {
		int technicalStrength = 0;
...
//	                + response.getStatusLine().getStatusCode());
			HttpEntity entity = response.getEntity();
			responseStr = EntityUtils.toString(entity);
			return parseResponseForTechnicalStrenght(responseStr);
		} catch (ClientProtocolException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		} catch (IOException e) {
